...
namespace eth
{
enum class ExtendedInstruction : uint16_t
{
    ...
    PRECOMPILED_ECRECOVER = 0x130,  ///< ecrecover pre-compiled contract
    PRECOMPILED_SHA256 = 0x131,     ///< sha256 pre-compiled contract
    PRECOMPILED_RIPEMD160 = 0x132,  ///< ripemd160 pre-compiled contract
};
